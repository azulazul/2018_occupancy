...
###############################
mysvm_path="./svm_rbf_model.dat";

# mysvm_model = train_bin(xttrain, yttrain, mysvm_path , 1)
# # --use the following to load the previously constructed model
mysvm_model = joblib.load(mysvm_path)
print "The best parameters are ", str(mysvm_model.best_params_), "score", mysvm_model.best_score_

yttest1_pred=mysvm_model.predict(xttest1)
...
yttest2_pred = mysvm_model.predict(xttest2)
